(function() {
    ...
    person.sayHello=function () {
        return 'Hello from Estebahn Molina!';
    };
    ...
    shoppers.forEach(function (shopper) {
        let discount = shopper.amount*.12
         if (shopper.amount < 200) {
                console.log('Sorry ' + shopper.name + ' but you only spent $ ' + shopper.amount + ' and that does not qualify you for a discount')
